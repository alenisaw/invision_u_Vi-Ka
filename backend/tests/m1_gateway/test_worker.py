...
from app.modules.m1_gateway.schemas import PipelineJobStatusView
...
async def test_worker_acks_completed_jobs() -> None:
    ...
    with patch("app.modules.m1_gateway.worker.AsyncSessionLocal") as session_local, patch(
        "app.modules.m1_gateway.worker.PipelineOrchestrator"
