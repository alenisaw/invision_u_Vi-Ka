...
from backend.app.modules.m5_nlp.embeddings import (
...
class EmbeddingsHelperTests(unittest.TestCase):
    ...
    def test_semantic_similarity_uses_local_embedding_backend(self) -> None:
        ...
        with patch("backend.app.modules.m5_nlp.embeddings._load_local_embedding_backend", return_value=(model, "cpu")):
