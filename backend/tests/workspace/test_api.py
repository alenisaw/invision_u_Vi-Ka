...
from app.modules.scoring.schemas import CandidateScore as CandidateScorePayload
from app.modules.explanation.schemas import ExplanationReport
...
def test_stats_route_wraps_success_response(client: TestClient) -> None:
    ...
    with patch(
        "app.modules.workspace.router.DashboardService.get_stats",
...
def test_candidates_route_returns_list_payload(client: TestClient) -> None:
    ...
    with patch(
        "app.modules.workspace.router.DashboardService.list_candidates",
...
def test_candidate_detail_route_returns_detail_payload(client: TestClient) -> None:
    ...
    with patch(
        "app.modules.workspace.router.DashboardService.get_candidate_detail",
