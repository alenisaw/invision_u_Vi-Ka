...
Purpose: Unit tests for the extraction-stage signal service.
"""
...
class ExtractionServiceTests(unittest.TestCase):
    """Validate the public extraction-stage service surface."""
    ...
    def build_request(self, transcript_text: str = "") -> ExtractionRequest:
    ...
    def test_extract_signals_returns_foundation_interview_envelope(self) -> None:
        """The extraction stage should detect Foundation Year interview criteria in candidate text."""
        ...
        self.assertEqual(envelope.extraction_model_version, "heuristic-v1")
    ...
    def test_extract_signals_uses_transcription_fallback_when_needed(self) -> None:
        """The extraction stage should use transcription fallback and still recover interview criteria."""
