...
from app.modules.extraction.groq_llm_client import GroqSignalClient
from app.modules.extraction.llm_shared import SignalGroupSpec, normalize_signal_container
from app.modules.extraction.source_bundle import SourceBundle
...
class LLMClientTests(unittest.TestCase):
    ...
    def test_groq_client_uses_bearer_auth_header(self) -> None:
        ...
        with patch("app.modules.extraction.groq_llm_client.httpx.Client", return_value=dummy_client):
