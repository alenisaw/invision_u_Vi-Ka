...
from app.modules.scoring.ml_model import HybridScoringModel
...
class ScoringServiceTests(unittest.TestCase):
    ...
    def test_score_candidate_returns_expected_shape(self) -> None:
        ...
        self.assertEqual(score.scoring_version, "scoring-v1")
    ...
    def test_model_can_be_saved_and_loaded(self) -> None:
        ...
        artifact_path = Path("backend/app/modules/scoring/artifacts/test_scoring_model.joblib")
        try:
