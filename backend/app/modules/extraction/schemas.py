"""
File: schemas.py
Purpose: Request models for the extraction-stage signal service.
"""
...
class ExtractionRequest(BaseModel):
    """Safe model-input payload consumed by the extraction stage."""

    model_config = ConfigDict(extra="ignore", populate_by_name=True)

    candidate_id: UUID = Field(default_factory=uuid4)
    signal_schema_version: str = Field(default="v1", min_length=1)
    extraction_model_version: str = Field(default="heuristic-v1", min_length=1)
