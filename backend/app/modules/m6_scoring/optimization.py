...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run decision-layer optimization for the M6 module.")
    ...
    print("\n[M6] Decision Search Top 10")
    print(frame.head(10).to_string(index=False))
    print("\n[M6] Recommended Configurations")
    ...
    if args.out_dir:
        ...
        print("\n[M6] Exported optimization artifacts")
