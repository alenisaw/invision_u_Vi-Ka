...
Purpose: Shared normalized source bundle and signal helper functions for M5.
"""
...
def build_source_bundle(request: M5ExtractionRequest, transcript_text: str | None = None) -> SourceBundle:
