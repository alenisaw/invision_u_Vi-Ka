"""
File: factors.py
Purpose: Human-readable factor and caution formatting helpers for the explanation stage.
"""

from __future__ import annotations

from .schemas import CautionBlock, ExplanationCautionFlag, ExplanationFactor, ExplanationSeverity
...
CAUTION_POLICY: dict[str, tuple[ExplanationSeverity, str, str]] = {
    "possible_ai_use": (
        "warning",
...
def factor_summary(factor: ExplanationFactor) -> str:
    return (
...
def caution_block(flag: ExplanationCautionFlag) -> CautionBlock:
