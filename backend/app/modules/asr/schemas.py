"""
File: schemas.py
Purpose: Shared request and response models for the ASR stage.
"""
...
class ASRTranscriptResult(BaseModel):
    """Final ASR output passed to the pipeline."""
...
# Defines the compact public contracts for ASR requests, segments, and results.
