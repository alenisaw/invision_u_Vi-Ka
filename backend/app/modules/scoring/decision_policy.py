...
Purpose: Explicit score routing and manual-review logic for the scoring stage.
"""
...
from .scoring_config import DecisionPolicyConfig
...
def build_decision_summary(
    ...
    if committee_ready and confidence_band == "HIGH":
...
def apply_decision_policy(
    ...
    committee_ready = (not manual_review_required) and score_status in policy.shortlist_eligible_statuses
    ...
    return DecisionOutcome(
        ...
        manual_review_required=manual_review_required,
        uncertainty_categories=uncertainty_categories,
        shortlist_eligible=committee_ready,
