...
Purpose: Canonical program normalization and program-aware weight helpers for the scoring stage.
"""

from __future__ import annotations

from .scoring_config import DEFAULT_POLICY_CONFIG, DEFAULT_PROGRAM_ID, PROGRAM_CATALOG, PROGRAM_WEIGHT_PROFILES
