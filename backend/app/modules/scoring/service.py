...
class ScoringService:
    ...
    def _build_caution_items(self, caution_flags: list[str]) -> list[ExplanationCautionFlag]:
        ...
        severity_map = {
            ...
            "speech_authenticity_risk": "warning",
        ...
        reason_map = {
            ...
            "requires_human_review": "Один или несколько quality/policy-check уже требуют ручной проверки комиссией.",
            "essay_replaced_by_video_transcript": "Текстовое эссе не приложено, поэтому narrative кандидата собран из транскрипции видео.",
            ...
            "possible_ai_use": "В нарративе есть признаки возможного использования ИИ, поэтому кейс стоит проверить вручную.",
            "authenticity_or_ai_risk": "Обнаружены сигналы недостоверности или AI-assisted writing, поэтому кейс стоит проверить вручную.",
            "speech_authenticity_risk": "Аудиоматериал выглядит неестественно ровным, поэтому стоит отдельно проверить риск синтетической речи.",
