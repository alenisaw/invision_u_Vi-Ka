...
from app.modules.privacy.separator import SeparatedLayers, separate
from app.modules.storage import StorageRepository


class PrivacyService:
    """Separates intake data into three privacy layers and persists them."""
    ...
    async def process(
        ...
        *,
        ...
        """Run three-layer separation and store the resulting records.

        Args:
            candidate_id: Existing candidate UUID created during input intake.
            payload: Raw intake request.
            age_eligible: Pre-computed during input intake.
            language_threshold_met: Pre-computed during input intake.
            data_completeness: Pre-computed during input intake.
            data_flags: Pre-computed during input intake.
            video_transcript: Optional ASR transcript.
