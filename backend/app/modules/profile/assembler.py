...
from app.modules.storage.models import Candidate, CandidateMetadata, CandidateModelInput
...
def assemble(
    ...
    Returns:
        CandidateProfile ready for downstream extraction and scoring stages.
    """
    ...
    layer3 = ModelInput(
        ...
        asr_flags=(
            model_input.asr_flags if isinstance(model_input.asr_flags, list) else []
        ),
    )
